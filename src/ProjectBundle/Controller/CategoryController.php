...
class CategoryController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProjectBundle\Form\CategoryType', $category);
    ...
    public function showAction(Category $category)
    {
        ...
        return $this->render('category/category.show.html.twig', array(
            'category' => $category,
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('ProjectBundle\Form\CategoryType', $category);
